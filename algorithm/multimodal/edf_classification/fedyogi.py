    ...
    def aggregate(self, models: list, modalities_list: list, beta1=0.9, beta2=0.999, epsilon=1e-8, m=None, v=None):
        ...
        for lead in range(self.n_leads):
            ...
            for k in global_dict.keys():
                ...
                new_model.feature_extractors[lead].v[k] = new_model.feature_extractors[lead].v[k] - (1 - beta2) * updates.pow(2) * torch.sign(new_model.feature_extractors[lead].v[k] - updates.pow(2))
